...
class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("JOKE BAT HAXEFLIXEL", create);

		#if (js && html5)
		#if (munit || (utest && openfl_enable_utest_legacy_mode))
		lime.system.System.embed("JOKE BAT HAXEFLIXEL", null, 640, 480);
		#end
		#else
		create(null);
		#end
	...
	public static function create(config):Void
	{
		...
		app.meta["file"] = "JOKE BAT HAXEFLIXEL";
		app.meta["name"] = "JOKE BAT HAXEFLIXEL";
		...
		#elseif air
		app.window.title = "JOKE BAT HAXEFLIXEL";
		#else
