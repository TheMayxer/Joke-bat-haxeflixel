...
HX_LOCAL_STACK_FRAME(_hx_pos_cbb4b77437007293_146_progress,"sys.thread.EventLoop","progress",0xd3ab8d20,"sys.thread.EventLoop.progress","D:\\HaxeToolkit\\haxe\\std/sys/thread/EventLoop.hx",146,0xdb85ed6b)
HX_LOCAL_STACK_FRAME(_hx_pos_cbb4b77437007293_179_loop,"sys.thread.EventLoop","loop",0x33ddc657,"sys.thread.EventLoop.loop","D:\\HaxeToolkit\\haxe\\std/sys/thread/EventLoop.hx",179,0xdb85ed6b)
namespace sys{
namespace thread{
...
bool EventLoop_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::sys::thread::NextEventTime EventLoop_obj::progress(){
            	HX_STACKFRAME(&_hx_pos_cbb4b77437007293_146_progress)
...
void EventLoop_obj::loop(){
            	HX_STACKFRAME(&_hx_pos_cbb4b77437007293_179_loop)
