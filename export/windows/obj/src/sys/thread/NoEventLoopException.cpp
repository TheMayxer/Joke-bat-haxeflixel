...
HX_DEFINE_STACK_FRAME(_hx_pos_8b70d7eb702d4dba_7_new,"sys.thread.NoEventLoopException","new",0x6e47ae47,"sys.thread.NoEventLoopException.new","D:\\HaxeToolkit\\haxe\\std/sys/thread/NoEventLoopException.hx",7,0xbdf2d2e1)
namespace sys{
namespace thread{
...
void NoEventLoopException_obj::__construct(::String __o_msg, ::haxe::Exception previous){
            	...
            	HX_STACKFRAME(&_hx_pos_8b70d7eb702d4dba_7_new)
