...
HX_LOCAL_STACK_FRAME(_hx_pos_702b6ced97854502_51_readMessage,"sys.thread._Thread.Thread_Impl_","readMessage",0x4f379df5,"sys.thread._Thread.Thread_Impl_.readMessage","D:\\HaxeToolkit\\haxe\\std/cpp/_std/sys/thread/Thread.hx",51,0xf3c3f938)
HX_LOCAL_STACK_FRAME(_hx_pos_702b6ced97854502_54_get_events,"sys.thread._Thread.Thread_Impl_","get_events",0x2940127e,"sys.thread._Thread.Thread_Impl_.get_events","D:\\HaxeToolkit\\haxe\\std/cpp/_std/sys/thread/Thread.hx",54,0xf3c3f938)
HX_LOCAL_STACK_FRAME(_hx_pos_702b6ced97854502_62_processEvents,"sys.thread._Thread.Thread_Impl_","processEvents",0xf30238cc,"sys.thread._Thread.Thread_Impl_.processEvents","D:\\HaxeToolkit\\haxe\\std/cpp/_std/sys/thread/Thread.hx",62,0xf3c3f938)
namespace sys{
namespace thread{
namespace _Thread{
...
bool Thread_Impl__obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::Dynamic Thread_Impl__obj::readMessage(bool block){
            	HX_STACKFRAME(&_hx_pos_702b6ced97854502_51_readMessage)
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(Thread_Impl__obj,readMessage,return )
 ...
 ::sys::thread::EventLoop Thread_Impl__obj::get_events( ::sys::thread::_Thread::HaxeThread this1){
            	HX_GC_STACKFRAME(&_hx_pos_702b6ced97854502_54_get_events)
...
void Thread_Impl__obj::processEvents(){
            	HX_STACKFRAME(&_hx_pos_702b6ced97854502_62_processEvents)
