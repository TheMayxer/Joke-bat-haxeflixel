...
HX_DEFINE_STACK_FRAME(_hx_pos_c7aca8f609a0251d_33_new,"sys.io.FileOutput","new",0x19e22a16,"sys.io.FileOutput.new","D:\\HaxeToolkit\\haxe\\std/cpp/_std/sys/io/FileOutput.hx",33,0xc71346e1)
HX_LOCAL_STACK_FRAME(_hx_pos_c7aca8f609a0251d_37_writeByte,"sys.io.FileOutput","writeByte",0x887099bd,"sys.io.FileOutput.writeByte","D:\\HaxeToolkit\\haxe\\std/cpp/_std/sys/io/FileOutput.hx",37,0xc71346e1)
HX_LOCAL_STACK_FRAME(_hx_pos_c7aca8f609a0251d_44_writeBytes,"sys.io.FileOutput","writeBytes",0xda15ec16,"sys.io.FileOutput.writeBytes","D:\\HaxeToolkit\\haxe\\std/cpp/_std/sys/io/FileOutput.hx",44,0xc71346e1)
HX_LOCAL_STACK_FRAME(_hx_pos_c7aca8f609a0251d_51_close,"sys.io.FileOutput","close",0xa583caee,"sys.io.FileOutput.close","D:\\HaxeToolkit\\haxe\\std/cpp/_std/sys/io/FileOutput.hx",51,0xc71346e1)
namespace sys{
namespace io{

void FileOutput_obj::__construct( ::Dynamic f){
            	HX_STACKFRAME(&_hx_pos_c7aca8f609a0251d_33_new)
...
void FileOutput_obj::writeByte(int c){
            	HX_STACKFRAME(&_hx_pos_c7aca8f609a0251d_37_writeByte)
HXDLIN(  37)		try {
...
int FileOutput_obj::writeBytes( ::haxe::io::Bytes s,int p,int l){
            	HX_STACKFRAME(&_hx_pos_c7aca8f609a0251d_44_writeBytes)
HXDLIN(  44)		try {
            			HX_STACK_CATCHABLE( ::Dynamic, 0);
...
void FileOutput_obj::close(){
            	HX_STACKFRAME(&_hx_pos_c7aca8f609a0251d_51_close)
