...
HX_DEFINE_STACK_FRAME(_hx_pos_dbd1592e888bd8fb_45_new,"IntIterator","new",0x5692054f,"IntIterator.new","D:\\HaxeToolkit\\haxe\\std/IntIterator.hx",45,0x3aae96f9)
HX_LOCAL_STACK_FRAME(_hx_pos_dbd1592e888bd8fb_54_hasNext,"IntIterator","hasNext",0xd8737ddc,"IntIterator.hasNext","D:\\HaxeToolkit\\haxe\\std/IntIterator.hx",54,0x3aae96f9)
HX_LOCAL_STACK_FRAME(_hx_pos_dbd1592e888bd8fb_63_next,"IntIterator","next",0x6932a124,"IntIterator.next","D:\\HaxeToolkit\\haxe\\std/IntIterator.hx",63,0x3aae96f9)

void IntIterator_obj::__construct(int min,int max){
            	HX_STACKFRAME(&_hx_pos_dbd1592e888bd8fb_45_new)
...
bool IntIterator_obj::hasNext(){
            	HX_STACKFRAME(&_hx_pos_dbd1592e888bd8fb_54_hasNext)
...
int IntIterator_obj::next(){
            	HX_STACKFRAME(&_hx_pos_dbd1592e888bd8fb_63_next)
