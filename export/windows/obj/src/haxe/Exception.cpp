...
HX_DEFINE_STACK_FRAME(_hx_pos_b872dbcef2b1d44a_5_new,"haxe.Exception","new",0xa32fba59,"haxe.Exception.new","D:\\HaxeToolkit\\haxe\\std/cpp/_std/haxe/Exception.hx",5,0xdb8b82f1)
HX_LOCAL_STACK_FRAME(_hx_pos_b872dbcef2b1d44a_56_toString,"haxe.Exception","toString",0x11a32013,"haxe.Exception.toString","D:\\HaxeToolkit\\haxe\\std/cpp/_std/haxe/Exception.hx",56,0xdb8b82f1)
HX_LOCAL_STACK_FRAME(_hx_pos_b872dbcef2b1d44a_76_get_message,"haxe.Exception","get_message",0x7b47a0d7,"haxe.Exception.get_message","D:\\HaxeToolkit\\haxe\\std/cpp/_std/haxe/Exception.hx",76,0xdb8b82f1)
HX_LOCAL_STACK_FRAME(_hx_pos_b872dbcef2b1d44a_19_caught,"haxe.Exception","caught",0xbc294f23,"haxe.Exception.caught","D:\\HaxeToolkit\\haxe\\std/cpp/_std/haxe/Exception.hx",19,0xdb8b82f1)
namespace haxe{

void Exception_obj::__construct(::String message, ::haxe::Exception previous, ::Dynamic native){
            	HX_STACKFRAME(&_hx_pos_b872dbcef2b1d44a_5_new)
...
::String Exception_obj::toString(){
            	HX_STACKFRAME(&_hx_pos_b872dbcef2b1d44a_56_toString)
...
::String Exception_obj::get_message(){
            	HX_STACKFRAME(&_hx_pos_b872dbcef2b1d44a_76_get_message)
...
HX_DEFINE_DYNAMIC_FUNC0(Exception_obj,get_message,return )
 ...
 ::haxe::Exception Exception_obj::caught( ::Dynamic value){
            	HX_GC_STACKFRAME(&_hx_pos_b872dbcef2b1d44a_19_caught)
