...
HX_DEFINE_STACK_FRAME(_hx_pos_dd2a1df6522401a7_23_new,"haxe.ValueException","new",0xb19045f8,"haxe.ValueException.new","D:\\HaxeToolkit\\haxe\\std/haxe/ValueException.hx",23,0x0835854f)
namespace haxe{

void ValueException_obj::__construct( ::Dynamic value, ::haxe::Exception previous, ::Dynamic native){
            	HX_STACKFRAME(&_hx_pos_dd2a1df6522401a7_23_new)
