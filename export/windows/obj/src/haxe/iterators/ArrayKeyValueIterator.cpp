...
HX_DEFINE_STACK_FRAME(_hx_pos_4f64e3dd4baea9fd_26_new,"haxe.iterators.ArrayKeyValueIterator","new",0x6bd8a13a,"haxe.iterators.ArrayKeyValueIterator.new","D:\\HaxeToolkit\\haxe\\std/haxe/iterators/ArrayKeyValueIterator.hx",26,0x78b257c0)
HX_LOCAL_STACK_FRAME(_hx_pos_4f64e3dd4baea9fd_35_hasNext,"haxe.iterators.ArrayKeyValueIterator","hasNext",0x73cdeb47,"haxe.iterators.ArrayKeyValueIterator.hasNext","D:\\HaxeToolkit\\haxe\\std/haxe/iterators/ArrayKeyValueIterator.hx",35,0x78b257c0)
HX_LOCAL_STACK_FRAME(_hx_pos_4f64e3dd4baea9fd_39_next,"haxe.iterators.ArrayKeyValueIterator","next",0xf1b472d9,"haxe.iterators.ArrayKeyValueIterator.next","D:\\HaxeToolkit\\haxe\\std/haxe/iterators/ArrayKeyValueIterator.hx",39,0x78b257c0)
namespace haxe{
namespace iterators{

void ArrayKeyValueIterator_obj::__construct(::cpp::VirtualArray array){
            	HX_STACKFRAME(&_hx_pos_4f64e3dd4baea9fd_26_new)
...
bool ArrayKeyValueIterator_obj::hasNext(){
            	HX_STACKFRAME(&_hx_pos_4f64e3dd4baea9fd_35_hasNext)
...
HX_DEFINE_DYNAMIC_FUNC0(ArrayKeyValueIterator_obj,hasNext,return )
 ...
 ::Dynamic ArrayKeyValueIterator_obj::next(){
            	HX_STACKFRAME(&_hx_pos_4f64e3dd4baea9fd_39_next)
