...
HX_DEFINE_STACK_FRAME(_hx_pos_453c540e30b965c4_76_new,"haxe.io.Path","new",0x1b96d677,"haxe.io.Path.new","D:\\HaxeToolkit\\haxe\\std/haxe/io/Path.hx",76,0x092ebd41)
HX_LOCAL_STACK_FRAME(_hx_pos_453c540e30b965c4_115_toString,"haxe.io.Path","toString",0xc0ab5735,"haxe.io.Path.toString","D:\\HaxeToolkit\\haxe\\std/haxe/io/Path.hx",115,0x092ebd41)
HX_LOCAL_STACK_FRAME(_hx_pos_453c540e30b965c4_134_withoutDirectory,"haxe.io.Path","withoutDirectory",0xdf35ce8e,"haxe.io.Path.withoutDirectory","D:\\HaxeToolkit\\haxe\\std/haxe/io/Path.hx",134,0x092ebd41)
HX_LOCAL_STACK_FRAME(_hx_pos_453c540e30b965c4_147_directory,"haxe.io.Path","directory",0xbcfe23c4,"haxe.io.Path.directory","D:\\HaxeToolkit\\haxe\\std/haxe/io/Path.hx",147,0x092ebd41)
HX_LOCAL_STACK_FRAME(_hx_pos_453c540e30b965c4_161_extension,"haxe.io.Path","extension",0x91c9c4d6,"haxe.io.Path.extension","D:\\HaxeToolkit\\haxe\\std/haxe/io/Path.hx",161,0x092ebd41)
HX_LOCAL_STACK_FRAME(_hx_pos_453c540e30b965c4_189_join,"haxe.io.Path","join",0x05c781f3,"haxe.io.Path.join","D:\\HaxeToolkit\\haxe\\std/haxe/io/Path.hx",189,0x092ebd41)
HX_LOCAL_STACK_FRAME(_hx_pos_453c540e30b965c4_210_normalize,"haxe.io.Path","normalize",0x585a68e4,"haxe.io.Path.normalize","D:\\HaxeToolkit\\haxe\\std/haxe/io/Path.hx",210,0x092ebd41)
...
HX_LOCAL_STACK_FRAME(_hx_pos_453c540e30b965c4_271_addTrailingSlash,"haxe.io.Path","addTrailingSlash",0x8b4f8e69,"haxe.io.Path.addTrailingSlash","D:\\HaxeToolkit\\haxe\\std/haxe/io/Path.hx",271,0x092ebd41)
HX_LOCAL_STACK_FRAME(_hx_pos_453c540e30b965c4_299_removeTrailingSlashes,"haxe.io.Path","removeTrailingSlashes",0x2dc73462,"haxe.io.Path.removeTrailingSlashes","D:\\HaxeToolkit\\haxe\\std/haxe/io/Path.hx",299,0x092ebd41)
namespace haxe{
namespace io{

void Path_obj::__construct(::String path){
            	HX_STACKFRAME(&_hx_pos_453c540e30b965c4_76_new)
...
::String Path_obj::toString(){
            	HX_STACKFRAME(&_hx_pos_453c540e30b965c4_115_toString)
...
::String Path_obj::withoutDirectory(::String path){
            	HX_GC_STACKFRAME(&_hx_pos_453c540e30b965c4_134_withoutDirectory)
...
::String Path_obj::directory(::String path){
            	HX_GC_STACKFRAME(&_hx_pos_453c540e30b965c4_147_directory)
...
::String Path_obj::extension(::String path){
            	HX_GC_STACKFRAME(&_hx_pos_453c540e30b965c4_161_extension)
...
::String Path_obj::join(::Array< ::String > paths){
            	HX_STACKFRAME(&_hx_pos_453c540e30b965c4_189_join)
...
::String Path_obj::normalize(::String path){
            	HX_GC_STACKFRAME(&_hx_pos_453c540e30b965c4_210_normalize)
...
::String Path_obj::addTrailingSlash(::String path){
            	HX_STACKFRAME(&_hx_pos_453c540e30b965c4_271_addTrailingSlash)
...
::String Path_obj::removeTrailingSlashes(::String path){
            	HX_STACKFRAME(&_hx_pos_453c540e30b965c4_299_removeTrailingSlashes)
