...
HX_LOCAL_STACK_FRAME(_hx_pos_9d7a3ae0f34cdfae_30___default_trace,"haxe.Log","__default_trace",0xe2f5e5d5,"haxe.Log.__default_trace","D:\\HaxeToolkit\\haxe\\std/cpp/_std/haxe/Log.hx",30,0x7653a85c)
namespace haxe{
...
void _hx_run( ::Dynamic v, ::Dynamic infos){
            	HX_STACKFRAME(&_hx_pos_9d7a3ae0f34cdfae_30___default_trace)
