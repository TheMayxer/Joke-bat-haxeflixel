...
HX_LOCAL_STACK_FRAME(_hx_pos_68a87da1cf64852c_172_charCodeAt,"_UnicodeString.UnicodeString_Impl_","charCodeAt",0xd9768435,"_UnicodeString.UnicodeString_Impl_.charCodeAt","D:\\HaxeToolkit\\haxe\\std/UnicodeString.hx",172,0xe8cffdc8)
HX_LOCAL_STACK_FRAME(_hx_pos_68a87da1cf64852c_320_substr,"_UnicodeString.UnicodeString_Impl_","substr",0xd1a740f0,"_UnicodeString.UnicodeString_Impl_.substr","D:\\HaxeToolkit\\haxe\\std/UnicodeString.hx",320,0xe8cffdc8)
HX_LOCAL_STACK_FRAME(_hx_pos_68a87da1cf64852c_420_get_length,"_UnicodeString.UnicodeString_Impl_","get_length",0x33b0a1ee,"_UnicodeString.UnicodeString_Impl_.get_length","D:\\HaxeToolkit\\haxe\\std/UnicodeString.hx",420,0xe8cffdc8)
...
bool UnicodeString_Impl__obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::Dynamic UnicodeString_Impl__obj::charCodeAt(::String this1,int index){
            	HX_STACKFRAME(&_hx_pos_68a87da1cf64852c_172_charCodeAt)
...
::String UnicodeString_Impl__obj::substr(::String this1,int pos, ::Dynamic len){
            	HX_STACKFRAME(&_hx_pos_68a87da1cf64852c_320_substr)
HXLINE( 321)		if ((pos < 0)) {
...
int UnicodeString_Impl__obj::get_length(::String this1){
            	HX_STACKFRAME(&_hx_pos_68a87da1cf64852c_420_get_length)
HXLINE( 421)		int l = 0;
HXLINE( 422)		{
